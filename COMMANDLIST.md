...
`>>blackjack`  |  Starts a game of Blackjack for you on the current server. You can specify the amount you want to bet on the game. Use bjdraw to draw a card. Use bjfold to fold and hope the dealer busts. And you can use bjquit to quit the game, in which case half your buyin will be refunded.  |  `>>blackjack 5000`
...
`>>translate`  |  Translates the given sentence from and to the inputted languages. If you do not know your language code, search Google for ISO 639.1 Laguage Codes.  |  `>>translate EN>JA Give me the freaking cake!`
