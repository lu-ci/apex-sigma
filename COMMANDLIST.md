...
`>>reqrole`  |  Sets a role that is required for some to use Sigma. If a user does not have this role, Sigma will ignore them entirely. Server Administrator Only.  |  `>>reqrole Bot Commander`
