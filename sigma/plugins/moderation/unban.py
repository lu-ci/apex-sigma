            ...
            if check_ban(message.author, channel):
                try:
                    ...
                    if target_user:
                        ...
                        await cmd.bot.send_message(message.channel, 'User **' + user_q + '** has been unbanned.')
                    else:
                        await cmd.bot.send_message(message.channel, 'A user with that name was not found in the server ban list.')
