...
def RequstOWProfile(initiator_data, ow_name):
    cmd_name = 'Overwatch'
    ...
    try:
        ...
        profile = base.save('profile.png') #base.save('profile.png')
        ...
        return (True, overwatch_profile, profile)
        ...
        try:
            ...
            return (False, profile_json['error'])
